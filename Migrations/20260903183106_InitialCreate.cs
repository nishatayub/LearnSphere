        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Changelog = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Enrollments_CourseVersions_CourseVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_CourseVersions_CourseVersionId",
                        column: x => x.CourseVersionId,
                        principalTable: "CourseVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgressRecords_Enrollments_EnrollmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_InstructorId_Status",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_CourseVersionId",
                table: "Enrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_CourseVersionId_OrderIndex",
                table: "Lessons",
